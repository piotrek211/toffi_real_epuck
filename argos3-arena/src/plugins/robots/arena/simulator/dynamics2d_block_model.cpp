...
#include "dynamics2d_block_model.h"
...
namespace argos {
   ...
   CDynamics2DBlockModel::CDynamics2DBlockModel(CDynamics2DEngine& c_engine,
   ...
   REGISTER_STANDARD_DYNAMICS2D_OPERATIONS_ON_ENTITY(CBlockEntity, CDynamics2DBlockModel);
